...
class _VolunteerPageState extends State<VolunteerPage> {
  ...
  final List<String> _interestOptions = [
    'Education', 'Healthcare', 'Disaster Relief', 'Clean Water',
    'Fundraising', 'Remote/Admin Support',
  ];
  ...
  Widget build(BuildContext context) {
    return PageScaffold(
     title: 'Volunteer | Hopeworks Foundation',
  description: 'Sign up to volunteer with Hopeworks Foundation across education, healthcare, disaster relief, and more.',
      body: ContentContainer(
        padding: const EdgeInsets.symmetric(vertical: 100),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Text('Get Involved', style: Theme.of(context).textTheme.displayMedium),
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Areas of interest', style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 12),
            Wrap(
              spacing: 10,
              runSpacing: 10,
  ...
  Widget _buildThankYou(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          const Icon(Icons.volunteer_activism, color: AppColors.primary, size: 48)
              .animate()
              .scale(duration: 400.ms, curve: Curves.easeOutBack),
          const SizedBox(height: 20),
          Text('Thanks for Signing Up!', style: Theme.of(context).textTheme.headlineLarge),
          const SizedBox(height: 12),
          Text(
