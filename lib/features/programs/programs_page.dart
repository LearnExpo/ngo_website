        ...
        child: Column(
          ...
          children: [
            ...
            ConstrainedBox(
              ...
              child: Text(
                'Every program below is funded directly by donors and run with '
                'local partners on the ground. Tap any program to see full details.',
...
class _ProgramListCard extends StatelessWidget {
  ...
  const _ProgramListCard({required this.program});
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('${(program.progress * 100).toInt()}% funded',
                    style: const TextStyle(
